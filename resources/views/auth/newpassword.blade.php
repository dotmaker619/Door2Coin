        ...
        <main id="js_sign-up" class="content login-wrapper registration-box sign-up active">
            <div class="login-inner">
                ...
                <div class="right to-left">
                    ...
                    <form class="changepassword-form" action="{{ route('postnewpassword') }}" method="post">
                        {{ csrf_field() }}
                        <div class="form-field-tab">
                            ...
                            <div class="form-align-items">
                                <div class="form-field-wrapper">
                                    <div class="field-error-wrapper field-newregistrationform-password required">
                                        <label class="control-label" for="newregistrationform-password"
                                        ...
                                        <input type="password" id="newregistrationform-password"
